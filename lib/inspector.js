...
function inspector(url, opts, cb) {
	...
	urlObj.ua = opts.ua || "Mozilla/5.0";
	if (oEmbedUrl.obj) oEmbedUrl.obj.ua = urlObj.ua;
...
function normalize(obj) {
	...
	if (!obj.html) {
		if (!obj.embed && obj.ext == "html" && (obj.type == "image" || obj.type == "audio" || obj.type == "video")) {
			obj.embed = obj.url;
		}
		if (obj.embed) {
